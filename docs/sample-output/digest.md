# Podman CI flake digest — 2026-08-16
...
## Failure clusters
### TEST_BUG (0.90, llm) — 37 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix/archive-put-volume-resolution-21861) — the branch looks like the common factor, not the infrastructure
...
### TEST_TIMEOUT (0.90, llm) — 31 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix/archive-put-volume-resolution-21861) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-12 → 2026-08-12
### HARNESS (1.00, regex) — 12 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
...
- seen: 2026-08-12 → 2026-08-12
### VM_INFRA (0.90, llm) — 8 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: bump-5.8.7-dev, bump_586, v5.8) — the branch looks like the common factor, not the infrastructure
...
### TEST_TIMEOUT (1.00, regex) — 5 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
...
### TEST_BUG (0.90, llm) — 4 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix-25362-config-log-level) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-12 → 2026-08-12
### TEST_BUG (0.90, llm) — 4 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix-kube-seccomp-profile, fix/archive-put-volume-resolution-21861) — the branch looks like the common factor, not the infrastructure
...
### VM_INFRA (0.90, llm) — 3 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
...
### TEST_TIMEOUT (0.90, llm) — 2 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix/archive-put-volume-resolution-21861, healthcheck-fix) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-12 → 2026-08-12
### UNKNOWN (0.00, llm) — 2 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix/archive-put-volume-resolution-21861) — the branch looks like the common factor, not the infrastructure
...
### TEST_TIMEOUT (1.00, llm) — 2 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: v5.8) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-06 → 2026-08-13
### UNKNOWN (0.00, llm) — 2 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: renovate/golang.org-x-net-0.x, v6.1) — the branch looks like the common factor, not the infrastructure
...
- jobs: windows machine hyperv
- seen: 2026-08-12 → 2026-08-12
### TEST_BUG (0.90, llm) — 2 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix/archive-put-volume-resolution-21861) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-12 → 2026-08-12
### PRODUCT_RACE (0.90, llm) — 2 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
...
- seen: 2026-08-10 → 2026-08-10
### NETWORK_INFRA (1.00, llm) — 2 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
...
- seen: 2026-08-10 → 2026-08-10
### TEST_BUG (0.90, llm) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: v5.8) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-13 → 2026-08-13
### NETWORK_INFRA (0.90, llm) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: renovate/golang.org-x-net-0.x) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-12 → 2026-08-12
### UNKNOWN (0.00, llm) — 1 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
...
- seen: 2026-08-07 → 2026-08-07
### TEST_BUG (0.90, llm) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix/machine-image-permissions) — the branch looks like the common factor, not the infrastructure
...
### TEST_TIMEOUT (0.90, llm) — 1 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
...
- jobs: sys local rootless fedora-current
- seen: 2026-08-09 → 2026-08-09
### TEST_BUG (0.90, llm) — 1 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
...
- seen: 2026-08-12 → 2026-08-12
### NETWORK_INFRA (1.00, regex) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix-swagger-warnings) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-04 → 2026-08-04
### TEST_BUG (0.90, llm) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix-secret-event-filter) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-11 → 2026-08-11
### TEST_BUG (0.90, llm) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix/archive-put-volume-resolution-21861) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-13 → 2026-08-13
### TEST_TIMEOUT (1.00, llm) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix/hyperv-vsock-ready-timeout) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-11 → 2026-08-11
### VM_INFRA (0.90, llm) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: renovate/github.com-sirupsen-logrus-1.x) — the branch looks like the common factor, not the infrastructure
...
- seen: 2026-08-12 → 2026-08-12
### TEST_TIMEOUT (0.90, llm) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: bump-6.1.1-dev) — the branch looks like the common factor, not the infrastructure
...
- jobs: macos machine applehv
- seen: 2026-08-12 → 2026-08-12
### VM_INFRA (0.90, llm) — 1 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
- signature: `Error: EOF`
...
- jobs: macos machine applehv
- seen: 2026-08-12 → 2026-08-12
### RUNNER_INFRA (1.00, regex) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: v6.1) — the branch looks like the common factor, not the infrastructure
...
- jobs: Validate source code changes
- seen: 2026-08-12 → 2026-08-12
### PRODUCT_RACE (0.90, llm) — 1 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
...
- jobs: sys local root fedora-prior
- seen: 2026-08-04 → 2026-08-04
### TEST_BUG (0.90, llm) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: config-port) — the branch looks like the common factor, not the infrastructure
...
- jobs: sys local root fedora-rawhide
- seen: 2026-08-11 → 2026-08-11
### RUNNER_INFRA (0.90, llm) — 1 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
...
- jobs: sys local rootless debian-sid
- seen: 2026-08-10 → 2026-08-10
### RUNNER_INFRA (0.90, llm) — 1 occurrence(s) · ⚠ never seen on main and never re-run to green (branches: fix-xfs-quota-selinux) — the branch looks like the common factor, not the infrastructure
...
- jobs: sys local rootless debian-sid
- seen: 2026-08-09 → 2026-08-09
### NETWORK_INFRA (1.00, llm) — 1 occurrence(s) · ⚠ never once passed on a re-run, so there is no evidence it is intermittent rather than simply broken
